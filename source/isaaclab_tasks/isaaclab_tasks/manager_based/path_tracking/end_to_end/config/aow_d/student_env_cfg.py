...
from isaaclab_tasks.manager_based.path_tracking.end_to_end.tracking_student_env_cfg import StudentPathTrackingEnvCfg
...
@configclass
class AoWDPathEnvCfg(StudentPathTrackingEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        # switch robot to aow-c
